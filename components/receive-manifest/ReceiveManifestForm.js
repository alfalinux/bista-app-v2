...
import ReceiveManifestTable from "./ReceiveManifestTable";

const ReceiveManifestForm = ({ dataManifest }) => {
  ...
  return (
    <div className="w-full p-4 flex flex-col gap-4">
      ...
      {isLoading ? null : router.query.cabangTujuan === undefined ? null : !router.query.cabangTujuan ? (
        ...
        <ReceiveManifestTable dataManifest={dataManifest} resetCabangTujuan={() => setCabangTujuan("")} />
      ) : (
...
export default ReceiveManifestForm;
