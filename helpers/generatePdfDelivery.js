...
const generatePdfDelivery = (data) => {
  let imglogo = base64logo();
  let imgbarcode = base64barcode(data.delivery.noDelivery);
    ...
    [
      ...
      },
      {
        content:
          ...
          " Koli" +
          " - " +
          d.paket.map((d) => d.beratDikenakan).reduce((acc, val) => acc + Number(val), 0) +
          " Kg",
        styles: {
          cellWidth: "wrap",
          cellPadding: { top: 1, right: 2, bottom: 0, left: 2 },
  ...
  doc.autoTable({
    ...
    body: [
      [
        {
          content: generateDate(data.delivery.deliveryCreatedAt),
  ...
  doc.autoTable({
    ...
    body: [
      [
        ...
        {
          content: data.delivery.dataKurir.cabangDesc.toUpperCase(),
          styles: { fontStyle: "bold" },
        },
      ],
      [
        ...
        {
          content: data.delivery.dataKurir.nama.toUpperCase(),
          styles: { fontStyle: "bold" },
        },
      ],
    ],
