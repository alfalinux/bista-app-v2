...
const generatePdfLabel = (data) => {
  ...
  if (data.paket.length <= 1) {
    ...
    doc.autoTable({
      ...
      body: [[{ content: 1 + " of " + data.paket.length, styles: { fontStyle: "bold" } }]],
    });
    ...
    doc.autoTable({
      ...
      body: [
        [
          ...
          {
            content: `Actual\n${
              Number(data.paket[0].beratAktual).toFixed(2).toLocaleString("id-ID") + " Kg"
            }`,
            styles: { fontStyle: "bold" },
          },
          {
            content: `Incharge\n${
              Number(data.paket[0].beratDikenakan).toFixed(2).toLocaleString("id-ID") + " Kg"
            }`,
            styles: { fontStyle: "bold" },
          },
    ...
    doc.autoTable({
      ...
      body: [
        [
          {
            content: `Keterangan: ${
              data.paket[0].keterangan.length > 110
                ? data.paket[0].keterangan.substring(0, 110) + "..."
                : data.paket[0].keterangan
            }`,
          },
        ],
      ],
...
export default generatePdfLabel;
