import { connectToMongoDB, findSuratJalanBelumReceive } from "../../../../helpers/mongodbConnection";
...
const handler = async (req, res) => {
  ...
  let result;
  try {
    result = await findSuratJalanBelumReceive(client, "data-surat-jalan", cabangTujuan);
  } catch (error) {
